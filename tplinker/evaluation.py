...
#         set_trace()
        ...
        if re.match(".*model_state_dict.*\.pt", file_name) and run_id in target_run_ids:
...
print(run_id2model_state_paths)
...
predict_statistics = {}
run_id2model_state_paths = {
    "4wfIVy6U": ["/home/ubuntu/repos/TPlinker-joint-extraction/tplinker/default_log_dir/4wfIVy6U/model_state_dict_8.pt"]
}
